...
public class Task12Test {
    @Test
    void countOfAnimalsWeightMoteThanHeightTest() {
        List<Animal> testCase = new LinkedList<>();
        Collections.addAll(testCase,
            new Animal("qwerty11", Type.CAT, Sex.M, 1, 101, 3, true),
            new Animal("qwerty222", Type.DOG, Sex.F, 4, 30, 70, true),
            new Animal("qwerty", Type.FISH, Sex.F, 0, 41, 5, false),
            new Animal("qwerty3333", Type.BIRD, Sex.F, 0, 41, 4, false)
        );
        assertEquals(1, Task12.countOfAnimalsWeightMoteThanHeight(testCase));
    }
}
